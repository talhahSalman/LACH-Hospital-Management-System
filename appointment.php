...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Fix the SQL query - status should be 'pending' by default
    $sql = "INSERT INTO appointments (first_name, last_name, email, phone, department_id, doctor_id, appointment_date, appointment_time, message, status, created_at) 
            VALUES ('$first_name', '$last_name', '$email', '$phone', $department_id, $doctor_id, '$appointment_date', '$appointment_time', '$message', 'pending', NOW())";
